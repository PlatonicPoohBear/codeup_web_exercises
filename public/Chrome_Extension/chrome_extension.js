(function() {
    ...
    'zus',
        ...
        // Called automatically when window is loaded. Passes 'search' as callback function
        // to 'getRandomWord'.
    ...
    function getRandomWord(callback) {
        ...
        // Callback function for getRandomWord. Makes request to Youtube API with random search term.
        // Passes response to 'onSearchResponse'.
    function search(searchTerm) {
        var request;
        var queryURL = 'https://www.googleapis.com/youtube/v3/search?part=id&q=' + searchTerm + '&type=video&key=AIzaSyA5wseCsGWqdg1YnYPoXXqCIjh2KW3_MSU';
        $.getJSON(queryURL, function(data) {
          request = data;
        }).done(function () {
            onSearchResponse(request);
        });
    ...
    $('#refresh').click(function() {
        ...
        // Calls 'onClientLoad' when window loads.
